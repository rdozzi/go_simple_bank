...
// execTx executes a funciton with a database transaction
...
// TransferTxParams contains the iput parameters of the transfer transaction
...
// TrnsferTxResult is the result of the transfer transaction
...
// It creates a transfer record, add account entries, and update the accounts' balance within a single db transaction
