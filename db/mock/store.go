...
// Source: github.com/rdozzi/simple_bank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) ListAccount(ctx context.Context, arg db.ListAccountParams) ([]db.Accounts, error) {
	m.ctrl.T.Helper()
