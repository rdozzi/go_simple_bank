...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xd5\x03\n" +
	"\n" +
	"SimpleBank\x12\x8e\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"Q\x92A4\x12\x0fCreate new user\x1a!Use this API to create a new user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12\x9e\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"d\x92AH\x12\n" +
	"Login user\x1a:Use this API to login user and get access & refresh tokens\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_user\x12\x94\x01\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"W\x92A:\x12\x0fUpdate new user\x1a'Use this API to update user information\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_userB\x85\x01\x92A`\x12^\n" +
	"\x0fSimple Bank API\"F\n" +
	"\x13Simple Bank Project\x12\x1dhttps://simplebankproject.com\x1a\x10none@example.com2\x031.2Z github.com/rdozzi/simple_bank/pbb\beditionsp\xe9\a"
